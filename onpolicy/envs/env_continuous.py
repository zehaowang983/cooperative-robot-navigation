...
class ContinuousActionEnv(object):
    ...
    def __init__(self, config):
        ...
        for agent in range(self.num_agent):
            ...
            # u_action_space = spaces.Box(
            #     low=np.array([0.0, -self.max_speed]),  # Linear velocity lower bound, Angular velocity lower bound
            #     high=np.array([+self.max_speed, +self.max_speed]),  # Linear velocity upper bound, Angular velocity upper bound
            #     dtype=np.float32,
            # )
