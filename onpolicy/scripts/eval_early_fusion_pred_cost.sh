...
exp="early_fusion_pred_cost_eval"
...
# use_traj=True
coop_mode=early
prediction_checkpoint_path='../SOGMP_plus/models_library_holo_no_pretrained_early_5/model15.pth'
model_dir='scripts/results/unity/3_scenes/rmappo/early_fusion_pred_cost/run1/models'
