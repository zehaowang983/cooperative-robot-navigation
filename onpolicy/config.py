...
def get_config():
    ...
    # parser.add_argument("--visual_size", type=int, default=50, help="visual observation size")
    # parser.add_argument("--vector_size", type=int, default=9, help="vector observation size")
    ...
    parser.add_argument(
        ...
        nargs=2,
        default=(64, 64),
        help="Specify the size as three integers separated by spaces, e.g., 50 50 1"
    )
    parser.add_argument(
        "--camera_size",
        type=int,
    ...
    parser.add_argument(
        "--conv_lstm_hidden_dim",
        type=int,
        default=1,
    )
    parser.add_argument(
        "--conv_lstm_num_layers",
        type=int,
        default=1,
    )
    ...
    #     "--config_file",
    #     type=str,
    #     default="../cooperative_bev_prediction/fiery/configs/multi_ego_coop.yml",
    ...
    # Lagrangian method parameters
    parser.add_argument(
        "--cost_limit", 
        type=float, 
        default=1,
        help="Cost constraint threshold that the agent should satisfy"
    )
    
    parser.add_argument(
        "--init_lagrangian_multiplier", 
        type=float, 
        default=0.1,
        help="Initial value for the Lagrangian multiplier lambda"
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.0,
        help="Minimum value for the Lagrangian multiplier"
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=10.0,
        help="Maximum value for the Lagrangian multiplier"
    )
